...
void TestFlipBookEffect::OnEnter() {
    ...
    //m_Flipbook = effectsManager.GetFlipbookEffect("Flame02");
    //m_Flipbook = effectsManager.GetFlipbookEffect("FireBall04");
    m_Flipbook = effectsManager.GetFlipbookEffect("Explosion00");
}
